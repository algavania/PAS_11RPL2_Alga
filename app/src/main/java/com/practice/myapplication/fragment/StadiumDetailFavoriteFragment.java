 ...
 * Use the {@link StadiumDetailFavoriteFragment#newInstance} factory method to
 * create an instance of this fragment.
 */
public class StadiumDetailFavoriteFragment extends Fragment {
    ...
    public StadiumDetailFavoriteFragment() {
     ...
     * @return A new instance of fragment StadiumDetailFavoriteFragment.
     */
    // TODO: Rename and change types and number of parameters
    public static StadiumDetailFavoriteFragment newInstance(String param1, String param2) {
        StadiumDetailFavoriteFragment fragment = new StadiumDetailFavoriteFragment();
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        tv_name = view.findViewById(R.id.tv_stadium_name_detail_favorite);
        tv_description = view.findViewById(R.id.tv_stadium_description_detail_favorite);
        tv_location = view.findViewById(R.id.tv_stadium_location_detail_favorite);
        img_team = view.findViewById(R.id.img_stadium_detail_favorite);

        linearLayout = view.findViewById(R.id.stadium_layout_favorite);
        relativeLayout = view.findViewById(R.id.stadium_layout_favorite_2);
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        return inflater.inflate(R.layout.fragment_stadium_detail_favorite, container, false);
    }
